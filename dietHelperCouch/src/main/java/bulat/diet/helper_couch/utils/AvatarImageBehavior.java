...
/**
 * Created by Yauheni.Bulat on 29.09.2016.
 */
...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<LinearLayout> {

    private final static float MIN_AVATAR_PERCENTAGE_SIZE   = 0.3f;
    private final static int EXTRA_FINAL_AVATAR_PADDING     = 8;
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, LinearLayout child, View dependency) {
        ...
        if (expandedPercentageFactor < mChangeBehaviorPoint) {
            ...
            lp.width = (int) (mStartWeidth - heightToSubtract);
