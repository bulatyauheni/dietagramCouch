...
import bulat.diet.helper_couch.item.Account;
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    attachments.add("https://play.google.com/store/apps/details?id=bulat.diet.helper_couch&referrer=utm_source%3DDG_VK_WALL_WC");
