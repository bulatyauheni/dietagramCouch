...
public class DietHelperActivity extends AppCompatActivity {
    ...
    public void goToCalendar(String clientsEmail, String clientsName, String limit) {
        SaveCouchInfo.setCurrentClientEmail(clientsEmail, this);
        SaveCouchInfo.setCurrentClientName(clientsName, this);
        SaveCouchInfo.setCurrentClientLimit(limit, this);

        ClientCalendarFragment nextFrag= new ClientCalendarFragment();
        this.getSupportFragmentManager().beginTransaction()
                .replace(android.R.id.content, nextFrag, "ClientCalendarFragment")
                .addToBackStack(null)
                .commit();
    }

    public void goToRegistration() {
   /*     CouchRegistrationFragment nextFrag= new CouchRegistrationFragment();
        this.getSupportFragmentManager().beginTransaction()
                .replace(android.R.id.content, nextFrag, "CouchRegistrationFragment")
                .addToBackStack(null)
                .commit();*/
