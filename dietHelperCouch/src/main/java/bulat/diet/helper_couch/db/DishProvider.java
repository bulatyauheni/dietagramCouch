...
public class DishProvider extends ContentProvider{
	...
	private static final String DISHLIST_URI_STRING = "content://bulat.diet.helper_couch.db.DishProvider/list_items";
	private static final String SPORTLIST_URI_STRING = "content://bulat.diet.helper_couch.db.DishProvider/sport_items";
	private static final String TODAYDISH_URI_STRING = "content://bulat.diet.helper_couch.db.DishProvider/day_items";
	private static final String MESSAGES_URI_STRING = "content://bulat.diet.helper_couch.db.DishProvider/message_table";
	private static final String TEMPLATE_URI_STRING = "content://bulat.diet.helper_couch.db.DishProvider/template_table";
	private static final String NOTIFICATION_URI_STRING = "content://bulat.diet.helper_couch.db.DishProvider/notification_table";
	...
	static {
		...
		uriMatcher.addURI("bulat.diet.helper_couch.db.DishProvider", "list_items", DISHLIST);
		uriMatcher.addURI("bulat.diet.helper_couch.db.DishProvider", "day_items", TODAYDISHLIST);
		uriMatcher.addURI("bulat.diet.helper_couch.db.DishProvider", "message_table", MESSAGELIST);
		uriMatcher.addURI("bulat.diet.helper_couch.db.DishProvider", "template_table", TEMPLATELIST);
		uriMatcher.addURI("bulat.diet.helper_couch.db.DishProvider", "notification_table", NOTIFICATIONLIST);
		uriMatcher.addURI("bulat.diet.helper_couch.db.DishProvider", "sport_items", SPORTLIST);
