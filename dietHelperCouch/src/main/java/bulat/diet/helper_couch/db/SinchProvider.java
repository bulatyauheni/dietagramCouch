...
public class SinchProvider extends ContentProvider{
	...
	private static final String SINCHLIST_URI_STRING = "content://bulat.diet.helper_couch.db.SinchProvider/list_items";
	...
	static {
		...
		uriMatcher.addURI("bulat.diet.helper_couch.db.SinchProvider", "list_items", SINCHLIST);
	}
